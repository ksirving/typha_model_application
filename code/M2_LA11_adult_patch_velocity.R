...
save(new_data, file="output_data/M2_LA11_typha_adult_patch_velocity_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/M2_LA11_typha_adult_patch_velocity_discharge_probs_2010_2017_TS.RData")

# probability as a function of discharge -----------------------------------


load( file="output_data/M2_LA11_typha_adult_patch_velocity_discharge_probs_2010_2017_TS.RData")
head(new_data)
...
write.csv(limits, "output_data/M2_LA11_adult_patch_velocity_Q_limits.csv")
...
write.csv(melt_time, "output_data/M2_LA11_typha_adult_patch_velocity_time_stats.csv")
...
write.csv(total_days, "output_data/M2_LA11_typha_adult_patch_velocity_total_days.csv")
...
head(melt_days)
## save df
write.csv(melt_days, "output_data/M2_LA11_typha_adult_patch_velocity_total_days_long.csv")
