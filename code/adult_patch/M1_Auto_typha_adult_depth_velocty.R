...
## depth model
load(file="/Users/katieirving/Documents/git/typha_model_application/models/dep_ptch_mdl.rda")
...
for(n in 1: length(h)) {
  ...
  file_name = paste("figures/Application_curves/Depth/", NodeName, "_Typha_adult_depth_prob_Q_thresholds.png", sep ="")
  ...
  ggplot(all_data, aes(x = Q, y=prob_fit)) +
    ...
    facet_wrap(~variable, scales="free_x", nrow=3, labeller=labeller(variable = labels)) +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.25, x=limits[1,2]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.25, x=limits[2,2]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.25, x=limits[3,2]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.25, x=limits[4,2]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.50, x=limits[5,2]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.50, x=limits[6,2]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.50, x=limits[7,2]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.50, x=limits[8,2]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.75, x=limits[9,2]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.75, x=limits[10,2]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.75, x=limits[11,2]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_MC"), aes(y=0.75, x=limits[12,2]), color="blue") +
    
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.25, x=limits[1,1]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.25, x=limits[2,1]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.25, x=limits[3,1]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.25, x=limits[4,1]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.50, x=limits[5,1]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.50, x=limits[6,1]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.50, x=limits[7,1]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.50, x=limits[8,1]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.75, x=limits[9,1]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.75, x=limits[10,1]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.75, x=limits[11,1]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_LOB"), aes(y=0.75, x=limits[12,1]), color="blue") +
    
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.25, x=limits[1,3]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.25, x=limits[2,3]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.25, x=limits[3,3]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.25, x=limits[4,3]), color="green") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.50, x=limits[5,3]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.50, x=limits[6,3]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.50, x=limits[7,3]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.50, x=limits[8,3]), color="red") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.75, x=limits[9,3]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.75, x=limits[10,3]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.75, x=limits[11,3]), color="blue") +
    geom_point(data = subset(all_data, variable =="depth_cm_ROB"), aes(y=0.75, x=limits[12,3]), color="blue") +
...
load(file="/Users/katieirving/Documents/git/typha_model_application/models/vel_ptch_mdl.rda")
...
for(n in 1: length(h)) {
  ...
  for(p in 1:length(positions)) {
    ...
    peakQ  <- max(peak$Q)
    min_limit <- filter(new_data, vel_m_s >0)
    min_limit <- min(min_limit$Q)
...
## depth model
load(file="/Users/katieirving/Documents/git/typha_model_application/models/dep_sdlng_mdl.rda")
