...
save(new_data, file="output_data/M1_LA20_2_typha_adult_patch_depth_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/M1_LA20_2_typha_adult_patch_depth_discharge_probs_2010_2017_TS.RData")

# probability as a function of discharge -----------------------------------


load( file="output_data/M1_LA20_2_typha_adult_patch_depth_discharge_probs_2010_2017_TS.RData")
head(new_data)
...
write.csv(limits, "output_data/M1_LA20_2_adult_patch_Depth_Q_limits.csv")

## plot with thresholds

png("Figures/Application_curves/Depth/LA20_2_adult_patch_depth_prob_Q_thresholds.png", width = 500, height = 600)
...
ggplot(new_data, aes(x = Q, y=prob_fit)) +
  ...
  labs(title = "LA20_2: Adult Patch/Depth: Probability ~ Q",
       y = "Probability",
...
write.csv(melt_time, "output_data/M1_LA20_2_typha_adult_patch_depth_time_stats.csv")
...
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_perc_time_above_threshold_non_critcal.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_perc_time_above_threshold_critcal.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/M1_LA20_2_typha_adult_patch_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/M1_LA20_2_typha_adult_patch_depth_total_days_long.csv")



## plot all ts
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
...
save(new_data, file="output_data/M1_LA20_2_typha_adult_patch_velocity_discharge_probability_time_series_red_columns.RData")
...
write.csv(limits, "output_data/M1_LA20_2_adult_patch_velocity_Q_limits.csv")

## plot with thresholds

png("Figures/Application_curves/Depth/LA20_2_adult_patch_velocity_prob_Q_thresholds.png", width = 500, height = 600)
...
ggplot(new_data, aes(x = Q, y=prob_fit)) +
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), legend.position = "none") +
  labs(title = "LA20_2: Adult Patch/Velocity: Probability ~ Q",
       y = "Probability",
       x = "Q (cfs)") #+ theme_bw(base_size = 15)
...
head(melt_time)
unique(melt_time$Probability_Threshold)
write.csv(melt_time, "output_data/M1_LA20_2_typha_adult_patch_velocity_time_stats.csv")
...
write.csv(total_days, "output_data/M1_LA20_2_typha_adult_patch_velocity_total_days.csv")
...
head(melt_days)
## save df
write.csv(melt_days, "output_data/M1_LA20_2_typha_adult_patch_velocity_total_days_long.csv")



## plot all ts
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_velocityh_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_velocity_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
## plot by season/critical period
png("Figures/Application_curves/Depth/LA20_2_typha_adult_patch_velocity_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
