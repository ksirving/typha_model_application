...
save(new_data, file="output_data/M3_LA14_typha_seedling_depth_discharge_probability_time_series_red_columns.RData")
...
save(new_data, file="output_data/M3_LA14_typha_seedling_depth_discharge_probs_2010_2017_TS.RData")
...
write.csv(limits, "output_data/M3_LA14_Typha_seedling_Depth_Q_limits.csv")

# plot discharge points ---------------------------------------------------

png("Figures/Application_curves/Depth/LA14_seedling_depth_prob_Q_thresholds.png", width = 500, height = 600)
...
write.csv(melt_time, "output_data/M3_LA14_typha_seedling_depth_time_stats.csv")
...
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_perc_time_above_threshold_annual.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_perc_time_above_threshold_non_critcal.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_perc_time_above_threshold_critcal.png", width = 500, height = 600)
...
write.csv(total_days, "output_data/M3_LA14_typha_seedling_depth_total_days.csv")
...
## save df
write.csv(melt_days, "output_data/M3_LA14_typha_seedling_depth_total_days_long.csv")
...
## plot all ts
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_lob_rob_mc_no_days_within_Q.png", width = 500, height = 600)
...
## plot by year
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_lob_rob_mc_no_days_within_Q_by_year.png", width = 500, height = 600)
...
png("Figures/Application_curves/Depth/LA14_typha_seedling_depth_lob_rob_mc_no_days_within_Q_by_season.png", width = 500, height = 600)
