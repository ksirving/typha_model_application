...
write.csv(limits, "output_data/M1_F57C_adult_patch_velocity_Q_limits.csv")
...
head(melt_time)
unique(melt_time$Probability_Threshold)
write.csv(melt_time, "output_data/M1_F57C_typha_adult_patch_velocity_time_stats.csv")
...
write.csv(total_days, "output_data/M1_F57C_typha_adult_patch_velocity_total_days.csv")
...
head(melt_days)
## save df
write.csv(melt_days, "output_data/M1_F57C_typha_adult_patch_velocity_total_days_long.csv")
